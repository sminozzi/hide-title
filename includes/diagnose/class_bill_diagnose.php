<?php namespace cardealer_BillDiagnose;
...
// >>>>>>>>>>>>>>>  fazer replace cardealer to ...

/*
// >>>>>>>>>>>>>>>> call
function cardealer_bill_my_custom_hooking_diagnose()
{
...
add_action("init", "cardealer_bill_my_custom_hooking_diagnose");
// end >>>>>>>>>>>>>>>>>>>>>>>>>
...
//
    ...
    {
        $last_notification_date = get_option("cardealer_bill_show_warnings");
        $today = date("Y-m-d");
    ...
    {
        if(!function_exists('cardealer_bill_strip_strong99'))
        {
            function cardealer_bill_strip_strong99($htmlString)
            {
                // return $htmlString;
                                ...
                                if ($is_javascript) {
                                    ...
                                    if (preg_match($pattern, $line, $matches)) {
                                        ...
                                        $log_entry = [
                                            ...
                                            "News Type" => $matches[1],
                                            "Problem Description" => cardealer_bill_strip_strong99(
                                                $matches[2]
                                            ),
                                        ];
...
*/
$diagnose_instance = cardealer_Bill_Diagnose::get_instance(
    $notification_url,
    $notification_url2,
    $plugin_text_domain,
    $plugin_slug
);
update_option("cardealer_bill_show_warnings", date("Y-m-d"));